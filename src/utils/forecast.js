...
const forecast = (lat, lon, callback) => {
    ...
    request({ url, json: true }, (error, { body } = {}) => {
        if (error) {
            ...
            callback(undefined, {
                forecast: `${body.weather[0].description.charAt(0).toUpperCase() + body.weather[0].description.slice(1)}. Temperature is ${
                    (body.main.temp - 273).toFixed(1)} degrees out. It feels like ${
